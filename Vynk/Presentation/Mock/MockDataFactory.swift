...
enum MockDataFactory {
    ...
    static func makeVynkContacts(
        count: Int
    ) -> [VynkContactModel] {

        let firstNames = [
            "Aarav", "Aditi", "Akash", "Ananya",
            "Bhavya", "Chandan", "Deepak",
            "Farhan", "Gagan", "Harsh",
            "Ishita", "Jatin", "Karan",
            "Laksh", "Manish", "Naina",
            "Parth", "Rahul", "Sahil",
            "Tarun", "Varun", "Yash", "Zara"
        ]
        ...
        return (0..<count).map { index in
            ...
            return VynkContactModel(
                avatar: MockImages.avatar,
                name: "\(firstName) \(lastName)",
                about: "Hey there! I am using Vynk."
            )
        }
    }
    
    static var chats: [MessageThreadRowModel] = [
        .init(
